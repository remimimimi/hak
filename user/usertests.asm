    ...
    5a8a:	00e6ea63          	bltu	a3,a4,5a9e <free+0x50>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    5aa4:	02059713          	slli	a4,a1,0x20
    5aa8:	9301                	srli	a4,a4,0x20
    5aaa:	0712                	slli	a4,a4,0x4
  ...
  if(p + p->s.size == bp){
    ...
    5ab8:	02061713          	slli	a4,a2,0x20
    5abc:	9301                	srli	a4,a4,0x20
    5abe:	0712                	slli	a4,a4,0x4
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    5b44:	b7e1                	j	5b0c <malloc+0x36>
      if(p->s.size == nunits)
    5b46:	02e48b63          	beq	s1,a4,5b7c <malloc+0xa6>
        p->s.size -= nunits;
    5b4a:	4137073b          	subw	a4,a4,s3
    5b4e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5b50:	1702                	slli	a4,a4,0x20
    5b52:	9301                	srli	a4,a4,0x20
    5b54:	0712                	slli	a4,a4,0x4
    5b56:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5b58:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5b5c:	00002717          	auipc	a4,0x2
    5b60:	7ea73a23          	sd	a0,2036(a4) # 8350 <freep>
      return (void*)(p + 1);
    5b64:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5b68:	70e2                	ld	ra,56(sp)
    5b6a:	7442                	ld	s0,48(sp)
    5b6c:	74a2                	ld	s1,40(sp)
    5b6e:	7902                	ld	s2,32(sp)
    5b70:	69e2                	ld	s3,24(sp)
    5b72:	6a42                	ld	s4,16(sp)
    5b74:	6aa2                	ld	s5,8(sp)
    5b76:	6b02                	ld	s6,0(sp)
    5b78:	6121                	addi	sp,sp,64
    5b7a:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5b7c:	6398                	ld	a4,0(a5)
    5b7e:	e118                	sd	a4,0(a0)
    5b80:	bff1                	j	5b5c <malloc+0x86>
  hp->s.size = nu;
    5b82:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5b86:	0541                	addi	a0,a0,16
    5b88:	00000097          	auipc	ra,0x0
    5b8c:	ec6080e7          	jalr	-314(ra) # 5a4e <free>
  return freep;
    5b90:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5b94:	d971                	beqz	a0,5b68 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5b96:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5b98:	4798                	lw	a4,8(a5)
    5b9a:	fa9776e3          	bgeu	a4,s1,5b46 <malloc+0x70>
    if(p == freep)
    5b9e:	00093703          	ld	a4,0(s2)
    5ba2:	853e                	mv	a0,a5
    5ba4:	fef719e3          	bne	a4,a5,5b96 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5ba8:	8552                	mv	a0,s4
    5baa:	00000097          	auipc	ra,0x0
    5bae:	b7e080e7          	jalr	-1154(ra) # 5728 <sbrk>
  if(p == (char*)-1)
    5bb2:	fd5518e3          	bne	a0,s5,5b82 <malloc+0xac>
        return 0;
    5bb6:	4501                	li	a0,0
    5bb8:	bf45                	j	5b68 <malloc+0x92>
